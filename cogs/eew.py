...
class eew(commands.Cog):
    ...
    async def eewop(self, ctx):
        ...
        embed.add_field(name="**電文バージョン**", value=eew['Body']['Intensity']['Areas[]']['''], inline=False)
        embed.add_field(name="**緊急地震速報の発表時刻**", value=eew['Body']['Intensity']['Areas[]']['''], inline=False)
        embed.add_field(name="**緊急地震速報を発表した管区気象台名**", value=eew['Body']['Intensity']['Areas[]']['''], inline=False)
